        ...
        <div className="min-h-screen bg-brand-dark text-white">
            ...
            <main className="p-4 md:p-6 max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                    <div className="bg-brand-med-dark p-4 rounded-lg border border-brand-border">
                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                        ...
                        className="bg-pink-600 text-white font-semibold rounded-lg px-5 py-2 transition-all duration-200 ease-in-out enabled:hover:bg-pink-500 enabled:active:scale-95 disabled:bg-brand-light disabled:cursor-not-allowed"
                    >
                        Download All as XML
                    </button>
                </div>
                        ...
                        {Object.keys(allChatHistories).length > 0 ? (
                           Object.entries(allChatHistories).map(([email, history]) => (
                                <div key={email} className="border border-brand-border rounded-lg p-4">
                                    <h3 className="text-md font-semibold text-amber-300/90 pb-2 mb-3 border-b border-brand-border/50">
